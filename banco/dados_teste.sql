...
(1, 1, 'Lógica de Programação', 80, 'Introdução à lógica, algoritmos e programação estruturada.', 'Universidade Estadual Alfa', 1, 'PENDENTE', NULL, NULL),
(2, 1, 'Banco de Dados', 60, 'Modelagem relacional, SQL e normalização.', 'Universidade Estadual Alfa', 2, 'PENDENTE', NULL, NULL),
(3, 2, 'Programação I', 80, 'Algoritmos, tipos de dados e estruturas básicas.', 'Faculdade Beta', 1, 'DEFERIDO', NULL, '2026-04-02 10:20:00'),
(4, 2, 'Desenvolvimento Web', 40, 'HTML, CSS e introdução ao JavaScript.', 'Faculdade Beta', 4, 'PENDENTE', NULL, NULL),
(5, 3, 'Circuitos Básicos', 80, 'Análise de circuitos resistivos e leis fundamentais.', 'Instituto Técnico Delta', 6, 'DEFERIDO', NULL, '2026-04-02 09:00:00'),
(6, 3, 'Eletrônica I', 60, 'Semicondutores, diodos e transistores.', 'Instituto Técnico Delta', 7, 'DEFERIDO', NULL, '2026-04-02 09:10:00'),
(7, 4, 'Instalações Prediais', 60, 'Projetos e dimensionamento de instalações.', 'Centro Universitário Ômega', 8, 'DEFERIDO', NULL, '2026-04-02 09:20:00'),
(8, 4, 'Circuitos Avançados', 40, 'Circuitos complexos e aplicações práticas.', 'Centro Universitário Ômega', 6, 'INDEFERIDO', 'Carga horária insuficiente para equivalência integral.', '2026-04-02 09:30:00'),
(9, 5, 'Administração Empresarial', 40, 'Fundamentos de gestão empresarial.', 'Faculdade Sigma', 9, 'INDEFERIDO', 'Carga horária inferior à disciplina de destino.', '2026-04-02 09:40:00'),
(10, 5, 'RH Estratégico', 30, 'Conceitos básicos de gestão de pessoas.', 'Faculdade Sigma', 10, 'INDEFERIDO', 'Conteúdo programático insuficiente e CH inferior.', '2026-04-02 09:50:00'),
(11, 6, 'Contabilidade Geral', 60, 'Noções introdutórias de contabilidade.', 'Universidade Gama', 11, 'PENDENTE', NULL, NULL),
(12, 6, 'Introdução à Administração', 60, 'Teorias da administração e planejamento.', 'Universidade Gama', 9, 'PENDENTE', NULL, NULL),
(13, 6, 'Gestão de Pessoas Aplicada', 60, 'Processos de recrutamento e seleção.', 'Universidade Gama', 10, 'PENDENTE', NULL, NULL),
(14, 7, 'Cálculo Diferencial', 80, 'Limites, derivadas e aplicações.', 'Universidade Horizonte', 12, 'PENDENTE', NULL, NULL),
(15, 7, 'Vetores e Geometria', 60, 'Vetores, retas, planos e coordenadas.', 'Universidade Horizonte', 13, 'DEFERIDO', NULL, '2026-04-02 11:00:00'),
(16, 7, 'Álgebra Matricial', 40, 'Matrizes, sistemas lineares e determinantes.', 'Universidade Horizonte', 14, 'PENDENTE', NULL, NULL),
(17, 8, 'Cálculo I', 80, 'Limites e derivadas.', 'Instituto Superior Lambda', 12, 'DEFERIDO', NULL, '2026-04-02 09:15:00'),
...
-- =========================================================
-- USUÁRIOS
-- IMPORTANTE: inserir por último por causa das FKs
-- =========================================================
INSERT INTO usuario (id, nome, email, senha_hash, perfil, estudante_id, coordenador_id, ativo) VALUES
(1, 'Administrador do Sistema', 'admin@cajui.com', 'admin123', 'ADMIN', NULL, NULL, TRUE),

(2, 'André Felipe Lopes', 'andre.felipe@ifnmg.edu.br', 'aluno123', 'ALUNO', 1, NULL, TRUE),
(3, 'Beatriz Costa', 'beatriz.costa@ifnmg.edu.br', 'aluno123', 'ALUNO', 2, NULL, TRUE),
(4, 'Lucas Pereira', 'lucas.pereira@ifnmg.edu.br', 'aluno123', 'ALUNO', 3, NULL, TRUE),
(5, 'Camila Rodrigues', 'camila.rodrigues@ifnmg.edu.br', 'aluno123', 'ALUNO', 4, NULL, TRUE),
(6, 'João Victor Mendes', 'joao.mendes@ifnmg.edu.br', 'aluno123', 'ALUNO', 5, NULL, TRUE),
(7, 'Ana Clara Santos', 'ana.santos@ifnmg.edu.br', 'aluno123', 'ALUNO', 6, NULL, TRUE),
(8, 'Gabriel Martins', 'gabriel.martins@ifnmg.edu.br', 'aluno123', 'ALUNO', 7, NULL, TRUE),
(9, 'Larissa Fernandes', 'larissa.fernandes@ifnmg.edu.br', 'aluno123', 'ALUNO', 8, NULL, TRUE),
(10, 'Rafael Dias', 'rafael.dias@ifnmg.edu.br', 'aluno123', 'ALUNO', 9, NULL, TRUE),
(11, 'Juliana Ribeiro', 'juliana.ribeiro@ifnmg.edu.br', 'aluno123', 'ALUNO', 10, NULL, TRUE),

(12, 'Mariana Souza', 'mariana.souza@ifnmg.edu.br', 'coord123', 'COORDENADOR', NULL, 1, TRUE),
(13, 'Carlos Henrique Lima', 'carlos.lima@ifnmg.edu.br', 'coord123', 'COORDENADOR', NULL, 2, TRUE),
